...
class MainActivityUser2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        timeInSeconds2 = intent.getLongExtra("timeInSeconds2", 0)

        val button1 = findViewById<Button>(R.id.button1)
        button1.setOnClickListener {
            val intent = Intent(this, StatisticsActivity2::class.java)
            intent.putExtra("timeInSeconds2", timeInSeconds2)
        ...
        if (savedInstanceState != null) {
            ...
            timeInSeconds2 = savedInstanceState.getLong("timeInSeconds2", 0)
        }
        ...
        timerTextView.text = formatTime(timeInSeconds2)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putLong("timeInSeconds2", timeInSeconds2)
    }
